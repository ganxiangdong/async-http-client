...
//        $req->requestHeaders = ["Test:1","Test-X:2"];
        ...
        $req2 = (new \AsyncHttp\Get("http://192.168.88.2/server.php", ['sleepTime' => 1]))->request();
    ...
    {
        $start = microtime(1);
        $req = (new \AsyncHttp\Get("http://192.168.88.2/server.php?sleepTime=120"))->setTimeout(1)->request();
